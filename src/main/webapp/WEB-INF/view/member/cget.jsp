	...
	<div class="container">
		...
		<div class="sign-tab__content sign-tab__content-active user-info">
				...
				<div class="input-box-wrap">
					<div class="input-box id">
						<input type="text" id="userid" name="c_id" class="has-label"
							value='<c:out value="${member.c_id }" />' maxlength="15" readonly="readonly">
						<label for="userid" class="fixed-label">아이디</label>
					</div>
				</div>
			...
			<section class="sign-section passwd">
				<ul class="input-box-wrap">
					<li class="input-box"><input type="password" id="passwd"
						...
						autocomplete="new-password" readonly="readonly"> <label for="passwd">비밀번호
					...
					<li class="input-box"><input type="password" id="passwd2"
						...
						required autocomplete="new-password"> <label for="passwd2" readonly="readonly">비밀번호
							재입력</label></li>
				</ul>
				<div class="valid-text">
			...
			<!-- <section class="sign-section birth">
						...
						<div class="input-box-wrap">
							<div class="input-box fixed">
								...
								<p class="fixed-data">1993년 10월 03일</p>
							</div>
						</div>
			...
			<section class="sign-section email">
				<ul class="input-box-wrap">
					<li class="input-box hide-last-child"><input type="text"
						...
						autocomplete="off" readonly="readonly"> <label class="fixed-label"
			...
			<section class="sign-section mobile">
				<ul class="input-box-wrap">
					<li class="input-box hide-last-child"><input type="tel"
						...
						value="<c:out value="${member.c_phone }" />" maxlength="11" readonly="readonly">
				...
				<div class="input-box-wrap">
					<div class="input-box">
						<input type="text" id="usernm" name="c_registnum"
							class="has-label"
							value="<c:out value="${member.c_registnum }" />" maxlength="20" readonly="readonly">
			...
			<section class="sign-section name">
				<div class="input-box-wrap">
					<div class="input-box">
						<input type="text" id="usernm" name="c_company" class="has-label"
							value="<c:out value="${member.c_company }" />" maxlength="20" readonly="readonly">
				...
				<div class="input-box-wrap">
					<div class="input-box">
						<input type="text" id="usernm" name="c_president"
							class="has-label"
							value="<c:out value="${member.c_president }" />" maxlength="20" readonly="readonly">
			...
			<section class="sign-section">
				<ul class="input-box-wrap">
					<li class="input-box"><input type="text" id="addr1"
						...
						value="<c:out value="${member.c_address }" />" readonly="readonly" readonly="readonly">
						<label for="addr1" class="">주소</label></li>
				</ul>
				<div class="valid-text">
			...
			<section class="sign-section">
				...
				<form id='operform' action="/member/cmodify" method="get">
      				<input type="hidden" id='c_id' name='c_id' value='<c:out value="${member.c_id}"/>'>
       			</form>
		</div>
	</div>
</body>
