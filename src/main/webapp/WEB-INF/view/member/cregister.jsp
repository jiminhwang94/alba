...
<body>
	...
	<form method="post" action="/member/cregister" name="cregister">
		<div class="container">
			<h1 class="sign__title">기업회원가입</h1>

			<section class="sign-section">
				<div class="agreement-wrap">
					<ul class="join__agreement-list">
						<li class="join__agreement-item join__agreement-item--all"><span
							class="input alone agreeCheck"> <input type="checkbox"
								id="allAgree" name="allAgree"> <label
							...
							<ul class="join__agreement-list-sub">
								...
								<li class="join__agreement-item">
									<div class="join__input-wrap">
										...
										</span> <a class="agreement-btn" href="#AgreementContents"> <em
											class="agreement-emphasis">[필수]</em> <span
									...
									<div
										...
										<iframe src="/policy/agreement_person_iframe.asp?202304241200"
								...
								<li class="join__agreement-item">
									<div class="join__input-wrap">
										...
										</span> <a class="agreement-btn" href="#PrivacyContents"> <em
											class="agreement-emphasis">[필수]</em> <span
								...
								<li class="join__agreement-item">
									<div class="join__input-wrap">
										...
										</span> <a class="agreement-btn" href="#PrivacyContentsChoice"> <em>[선택]</em>
								...
								<li class="join__agreement-item">
									<div class="join__input-wrap">
										...
										</span> <a class="agreement-btn" href="#AdContentsSms"> <em>[선택]</em>
											광고성 정보 수신 동의(SMS/MMS) <span
											class="sign-arrow sign-arrow--agreement"></span>
										</a>
									</div>
									<div
								...
								<li class="join__agreement-item">
									<div class="join__input-wrap">
										...
										</span> <a class="agreement-btn" href="#AdContentsEmail"> <em>[선택]</em>
											광고성 정보 수신 동의(이메일) <span
											class="sign-arrow sign-arrow--agreement"></span>
										</a>
									</div>
									<div
			...
			<section class="sign-section passwd">
				<ul class="input-box-wrap">
					<li class="input-box"><input type="password" id="passwd"
						name="c_password" class="has-label" value=""
						autocomplete="new-password" required oninvalid="this.setCustomValidity('비밀번호 입력 해주세요')" > <label for="passwd">비밀번호<span>8-15자의
					...
					<li class="input-box"><input type="password" id="passwd2"
						...
						required oninvalid="this.setCustomValidity('비밀번호 입력 해주세요')"> <label for="passwd2">비밀번호 재입력</label></li>
				</ul>
			</section>
			...
			<section class="sign-section">
				<ul class="input-box-wrap">
					<li id="inputboxemail" class="input-box email hide-last-child">
						<input type="text" id="email" class="has-label" name="c_email"
						value="" maxlength="50" autocomplete="off" required oninvalid="this.setCustomValidity('이메일 입력 해주세요')"> <label
						for="email">이메일</label>
					</li>
				</ul>
				<!-- 이메일 자동완성 기능 -->
			...
			<section class="sign-section">
				<ul class="input-box-wrap">
					<li class="input-box"><input type="text" id="htel"
						class="has-label" name="c_phone" value="" maxlength="11" required>
			...
			<section class="sign-section name">
				<div class="input-box-wrap">
					<div class="input-box">
						<input type="text" id="registnum" class="has-label" name="c_registnum"
							maxlength="20" required> <label for="usernm">사업자 등록번호</label>
					</div>
				</div>
				<div class="valid-text">
					<p id="msg_registnum" class="msg"></p>
				</div>
			</section>
			...
			<section class="sign-section name">
				<div class="input-box-wrap">
					<div class="input-box">
						<input type="text" id="company" class="has-label" name="c_company"
							maxlength="20" required> <label for="usernm">회사</label>
					</div>
				</div>
				<div class="valid-text">
					<p id="msg_company" class="msg"></p>
				</div>
			</section>
			...
			<section class="sign-section name">
				<div class="input-box-wrap">
					<div class="input-box">
						<input type="text" id="usernm" class="has-label" name="c_president"
							maxlength="20" required> <label for="usernm">대표자명</label>
					</div>
				</div>
				<div class="valid-text">
			...
			<section class="sign-section">
				<ul class="input-box-wrap">
					<li class="input-box"><input type="text" id="adress"
						class="has-label" name="c_address" required> <label
						for="htel">주소</label></li>
				</ul>
				<div class="valid-text">
			...
			<section class="sign-section">
				<ul class="input-box-wrap">
					<li class="input-box"><input type="text" id="path"
						class="has-label" name="c_path" required> <label
						for="htel">가입 경로</label></li>
				</ul>
				<div class="valid-text">
			...
			<section class="sign-section">
				<div class="sign-section__title">
					<div class="tooltip">
						<span class="tooltic__title">개인정보 유효기간 선택</span>
						<div class="tooltic__button-wrap">
							<a href="javascript:void(0);" class="tooltic__button">도움말</a>
